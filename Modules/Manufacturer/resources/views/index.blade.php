<x-dashboard::layouts.master :title="'Manufacturers'">
    <div class="content">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-5">
                                    @can('manufacturer_add')
                                        <a href="{{ route('manufacturer.create') }}" class="btn btn-danger mb-2"><i
                                            class="mdi mdi-plus-circle me-2"></i> Add Manufacturer</a>
                                    @endcan
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-action">
                                                    @can('manufacturer_edit')
                                                        <a href="{{ route('manufacturer.edit', $item->id) }}" class="action-icon"> <i
