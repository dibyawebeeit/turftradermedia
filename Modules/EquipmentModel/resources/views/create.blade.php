<x-dashboard::layouts.master :title="'Add Equipment Model'">
    <div class="content">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Equipment Model</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Add Equipment Model</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('equipmentmodel.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
