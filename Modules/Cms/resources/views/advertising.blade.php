<x-dashboard::layouts.master :title="'Advertising'">
    <div class="content">
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('cms.submit_advertising') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="button_text" class="form-label">Button Text <sup>*</sup></label>
                                            <input type="text" class="form-control" name="button_text" placeholder="Button Text"
                                                value="{{ $dataList->button_text }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="button_url" class="form-label">Button Url <sup>*</sup></label>
                                            <div class="input-group">
                                                <span class="input-group-text">{{ url('') }}/</span>
                                                <input type="text" class="form-control" 
                                                    name="button_url" value="{{ $dataList->button_url }}" placeholder="Button Url" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
