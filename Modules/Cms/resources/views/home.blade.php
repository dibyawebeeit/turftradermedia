<x-dashboard::layouts.master :title="'Cms Home'">
    <div class="content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">CMS Home</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('cms.submit_home') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="title" class="form-label">Title 1 <sup>*</sup></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="title1" class="form-label">Title 2</label>
