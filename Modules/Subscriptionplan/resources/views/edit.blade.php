                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="any" class="form-control" name="monthly_price" placeholder="Price" value="{{ old('monthly_price',$dataList->monthly_price) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="type" required>
                                                <option value="monthly" {{ $dataList->type=='monthly'?'selected':'' }}>Monthly</option>
                                                <option value="onetime" {{ $dataList->type=='onetime'?'selected':'' }}>One Time</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
