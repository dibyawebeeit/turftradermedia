                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <input type="checkbox" id="switch1" name="publish_status" {{ $dataList->publish_status==1?'checked':'' }} data-switch="bool"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <input type="checkbox" id="switch1" name="admin_approval" {{ $dataList->admin_approval==1?'checked':'' }} data-switch="bool"/>
                                            <label for="switch1" data-on-label="On" data-off-label="Off"></label>
                                        </div>
                                    </div>
                                </div> <!-- end row -->
                                @if (count($dataList->images) > 0)
                                    <div class="col-md-12">
                                        <h4>Gallery</h4>
                                        <div class="mb-3">
                                                <div class="row justify-content-center">
                                                    @foreach ($dataList->images as $item)
                                                        <div class="col-md-2">
