                        ...
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <p class="mb-0 text-muted">
                                    ...
                                    <a href="{{ route('customer.index') }}"><span class="text-nowrap">view</span></a>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    ...
                    <div class="col-sm-3">
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Equipments</h5>
                    ...
                    <div class="col-sm-3">
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Subscription</h5>
                                <h3 class="mt-3 mb-3">{{ $total_subscription }}</h3>
                                <p class="mb-0 text-muted">
                                    {{-- <span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i> 7.00%</span> --}}
                                    <a href="{{ route('subscription.index') }}"><span class="text-nowrap">view</span></a>
                                </p>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                    ...
                    <div class="col-sm-3">
                        <div class="card widget-flat">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Growth">Subscription Amount</h5>
                                <h3 class="mt-3 mb-3">{{ format_price($total_subscription_amount) }}</h3>
                                <p class="mb-0 text-muted">
