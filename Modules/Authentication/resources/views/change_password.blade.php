<x-authentication::layouts.master :title="'Change Password'">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center w-75 m-auto">
                                <h4 class="text-dark-50 text-center pb-0 fw-bold">Change Password</h4>
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                <script>
                                    setTimeout(function() {
                                        window.location.href = "{{ route('authentication.index') }}";
                                    }, 3000);
                                </script>
                                @endif
                            </div>
                            ...
                            @endif
                            <form method="POST" action="{{route('admin.submit_change_password')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                       <div class="mb-3">
