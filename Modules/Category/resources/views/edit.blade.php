<x-dashboard::layouts.master :title="'Edit Category'">
    <div class="content">
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('category.update',$dataList->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            @if ($dataList->image =='')
                                                <img src="{{ noImage() }}" alt="No Image" style="height: 50px;width:50px;">
                                            @else
                                                <img src="{{ asset('uploads/categoryImage/'.$dataList->image) }}" alt="Image" style="height: 50px;width:50px;">
                                            @endif
